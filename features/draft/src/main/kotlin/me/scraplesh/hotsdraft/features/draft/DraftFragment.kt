...
class DraftFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    constraintlayout_draft_hero_proposals.viewTreeObserver
      .addOnGlobalLayoutListener(object : ViewTreeObserver.OnGlobalLayoutListener {
        override fun onGlobalLayout() {
          val minHeight = coordinatorlayout_draft.height - constraintlayout_draft_heroes.height
          constraintlayout_draft_hero_proposals.minHeight = minHeight
          BottomSheetBehavior.from(constraintlayout_draft_hero_proposals).peekHeight = minHeight

          constraintlayout_draft_hero_proposals.viewTreeObserver.removeOnGlobalLayoutListener(this)
        }
      })
  }
