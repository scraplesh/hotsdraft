...
fun Hero.getBattlegroundCompliance(battleground: Battleground) =
    (this to battleground).battleGroundCompliance

val Hero.strongBattlegrounds: List<Battleground>
  get() = Battleground.values()
      .filter { battleground ->
          (this to battleground).battleGroundCompliance == BattlegroundCompliance.Strong
      }

val Hero.averageBattlegrounds: List<Battleground>
    get() = Battleground.values()
        .filter { battleground ->
            (this to battleground).battleGroundCompliance == BattlegroundCompliance.Average
        }

val Hero.weakBattlegrounds: List<Battleground>
    get() = Battleground.values()
        .filter { battleground ->
            (this to battleground).battleGroundCompliance == BattlegroundCompliance.Weak
        }

val Hero.unknownBattlegrounds: List<Battleground>
    get() = Battleground.values()
        .filter { battleground ->
            (this to battleground).battleGroundCompliance == BattlegroundCompliance.Unknown
        }
